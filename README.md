...
You can go to MR.Phatsin original file in [MR.Phatsin Rebalance bot](https://github.com/Phatsin/mango-client-v3)

And please read Medium blog from MR.Phatsin for more information.
